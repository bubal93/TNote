...
public class CurrentTasksAdapter extends TaskAdapter {
    ...
    private static final long ONE_DAY_LENGHT_IN_MILLIS = 86400000;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (item.isTask()) {
            ...
            //Change data color for overdue tasks.
            if (task.getDate() != 0
                    && task.getDate() < Calendar.getInstance().getTimeInMillis() - ONE_DAY_LENGHT_IN_MILLIS) {
                taskViewHolder.date.setTextColor(resources.getColor(R.color.red));
            } else {
            ...
            taskViewHolder.priority.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    taskViewHolder.title.setTextColor(resources.getColor(R.color.pri_text_disabled_material_light));
                    taskViewHolder.date.setTextColor(resources.getColor(R.color.sec_text_disabled_material_light));
                    taskViewHolder.priority.setColorFilter(resources.getColor(task.getPriorityColor()));

                    //Setting up an animation for moving the task to category "done"
