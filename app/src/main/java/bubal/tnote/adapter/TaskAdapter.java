    ...
    public void checkSeparators(int type) {
        switch (type) {
            ...
            case ModelSeparator.TYPE_TOMORROW:
                ...
                break;
            case ModelSeparator.TYPE_NEXT_SEVEN_DAYS:
                containsSeparatorNextSevenDays = false;
                break;
            case ModelSeparator.TYPE_FUTURE:
                containsSeparatorFuture = false;
                break;
            case ModelSeparator.TYPE_NO_DATE:
                containsSeparatorNoDate = false;
                break;
        }
    }
