...
public class EditTaskDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        //Adding 1 hour to new task if Date not specified
        calendar.set(Calendar.HOUR_OF_DAY, calendar.get(Calendar.HOUR_OF_DAY) + 1);

        //If date wasn't changed during editing of the task, set the old one
        ...
        if (etDate != null) {
            etDate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (etDate.length() == 0) etDate.setText(" ");
        ...
        if (etTime != null) {
            etTime.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (etTime.length() == 0) etTime.setText(" ");
        ...
        alertDialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                //To prevent creation of empty tasks
                if (etTitle != null) {
                    if (etTitle.length() == 0) {
